    ...
    <div class="flex min-h-screen">
      <div class="relative flex w-full items-center justify-center lg:w-2/2">
        <div class="max-w-[480px] p-5 md:p-10">
            <div v-show="emailSection" id="emailSection" class="pt-6 hidden">
            ...
            <div v-show="loginSection" id="loginSection">
              <h2 class="mb-3 text-3xl font-bold">How do you want to login ?</h2>
              <div id="loginSelector" class="">
                <div class="panel group flex items-center rounded-md p-2.5" id="selectPassword">
                ...
                <div class="panel group flex items-center rounded-md p-2.5 mt-2" id="selectPassword">
                  <div class="flex items-center">
                    <div class="h-9 w-9 ltr:mr-3 rtl:ml-3">
                      <div class="grid h-9 w-9 place-content-center rounded-md bg-secondary-light text-secondary dark:bg-secondary dark:text-secondary-light ">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="h-9 w-9 ltr:mr-3 rtl:ml-3">
                      <div class="grid h-9 w-9 place-content-center rounded-md bg-secondary-light text-secondary dark:bg-secondary dark:text-secondary-light ">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path opacity="0.5" d="M15 5H9" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
                          <circle opacity="0.5" cx="12" cy="17" r="2" stroke="#1C274C" stroke-width="1.5"/>
                        </svg>
                      </div>
                    </div>
                    <div class="flex-1">
                ...
                <div class="panel group flex items-center rounded-md p-2.5 mt-2" id="selectPassword">
                  <div class="flex items-center">
                    <div class="h-9 w-9 ltr:mr-3 rtl:ml-3">
                      <div class="grid h-9 w-9 place-content-center rounded-md bg-secondary-light text-secondary dark:bg-secondary dark:text-secondary-light ">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5.5 15.5C5.5 14.5572 5.5 14.0858 5.79289 13.7929C6.08579 13.5 6.55719 13.5 7.5 13.5H8.5C9.44281 13.5 9.91421 13.5 10.2071 13.7929C10.5 14.0858 10.5 14.5572 10.5 15.5V16.5C10.5 17.4428 10.5 17.9142 10.2071 18.2071C9.91421 18.5 9.44281 18.5 8.5 18.5C7.08579 18.5 6.37868 18.5 5.93934 18.0607C5.5 17.6213 5.5 16.9142 5.5 15.5Z" stroke="#1C274C" stroke-width="1.5"/>
                          <path d="M5.5 8.5C5.5 7.08579 5.5 6.37868 5.93934 5.93934C6.37868 5.5 7.08579 5.5 8.5 5.5C9.44281 5.5 9.91421 5.5 10.2071 5.79289C10.5 6.08579 10.5 6.55719 10.5 7.5V8.5C10.5 9.44281 10.5 9.91421 10.2071 10.2071C9.91421 10.5 9.44281 10.5 8.5 10.5H7.5C6.55719 10.5 6.08579 10.5 5.79289 10.2071C5.5 9.91421 5.5 9.44281 5.5 8.5Z" stroke="#1C274C" stroke-width="1.5"/>
                          <path d="M13.5 15.5C13.5 14.5572 13.5 14.0858 13.7929 13.7929C14.0858 13.5 14.5572 13.5 15.5 13.5H16.5C17.4428 13.5 17.9142 13.5 18.2071 13.7929C18.5 14.0858 18.5 14.5572 18.5 15.5C18.5 16.9142 18.5 17.6213 18.0607 18.0607C17.6213 18.5 16.9142 18.5 15.5 18.5C14.5572 18.5 14.0858 18.5 13.7929 18.2071C13.5 17.9142 13.5 17.4428 13.5 16.5V15.5Z" stroke="#1C274C" stroke-width="1.5"/>
                          <path d="M13.5 7.5C13.5 6.55719 13.5 6.08579 13.7929 5.79289C14.0858 5.5 14.5572 5.5 15.5 5.5C16.9142 5.5 17.6213 5.5 18.0607 5.93934C18.5 6.37868 18.5 7.08579 18.5 8.5C18.5 9.44281 18.5 9.91421 18.2071 10.2071C17.9142 10.5 17.4428 10.5 16.5 10.5H15.5C14.5572 10.5 14.0858 10.5 13.7929 10.2071C13.5 9.91421 13.5 9.44281 13.5 8.5V7.5Z" stroke="#1C274C" stroke-width="1.5"/>
                          <path opacity="0.5" d="M22 14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
                          <path opacity="0.5" d="M10 22C6.22876 22 4.34315 22 3.17157 20.8284C2 19.6569 2 17.7712 2 14" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
                          <path opacity="0.5" d="M10 2C6.22876 2 4.34315 2 3.17157 3.17157C2 4.34315 2 6.22876 2 10" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
                          <path opacity="0.5" d="M14 2C17.7712 2 19.6569 2 20.8284 3.17157C22 4.34315 22 6.22876 22 10" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>
                        </svg>
                      </div>
                    </div>
                    <div class="flex-1">
              ...
              <div id="loginOneTimeEmail" class="hidden">
                <label>One time password</label>
                <div>
                  <input
                      id="ote1"
                      type="text"
                      class="form-input w-11"
                      v-model="ote1"
                  />
                  <input
                      id="ote1"
                      type="text"
                      class="form-input w-11 ml-2"
                      v-model="ote1"
                  />
                  <input
                      id="ote1"
              ...
              <div id="loginPassword" class="pt-4 hidden">
                <input
                    id="ote1"
                    type="password"
                    class="form-input"
